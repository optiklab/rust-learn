...
/////////////// A library to keep track of how close a value is ////////////////
//////// to a maximum value and warn when the value is at certain levels ///////
pub trait Messenger {
...
mod tests {
    ...
    impl Messenger for MockMessenger {
        fn send(&self, message: &str) {
            ...
            // Another example: 
            // Creating two mutable references in the same scope to see 
